...
async function checkMonthCol() {
    console.log("Checking commissions for Janace with month='2026-01-01'");
    ...
    console.log(`Total commissions (month='2026-01-01'): ${comms.length}`);
