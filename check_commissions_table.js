...
async function checkCommissions() {
    console.log("Checking 'commissions' table for Agent ID: 6");
    ...
    console.log(`Total commissions: ${comms.length}`);
    if (comms.length > 0) {
        console.log("Last 5 commissions:");
        console.log(JSON.stringify(comms.slice(-5), null, 2));
    }
}
